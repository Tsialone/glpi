...
export class UpdateJoin1780576510329 implements MigrationInterface {
    name = 'UpdateJoin1780576510329'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_articles"("id", "name", "description") SELECT "id", "name", "description" FROM "articles"`);
        await queryRunner.query(`DROP TABLE "articles"`);
        await queryRunner.query(`ALTER TABLE "temporary_articles" RENAME TO "articles"`);
        await queryRunner.query(`CREATE TABLE "temporary_categories" ("id" integer PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "created" datetime NOT NULL)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "articles" RENAME TO "temporary_articles"`);
        await queryRunner.query(`CREATE TABLE "articles" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" text NOT NULL)`);
        await queryRunner.query(`INSERT INTO "articles"("id", "name", "description") SELECT "id", "name", "description" FROM "temporary_articles"`);
        await queryRunner.query(`DROP TABLE "temporary_articles"`);
    }
