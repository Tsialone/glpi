...
var sortable_esm_exports = /* @__PURE__ */ __exportAll({
...
function MultiDragPlugin() {
	function MultiDrag(sortable) {
		for (var fn in this) if (fn.charAt(0) === "_" && typeof this[fn] === "function") this[fn] = this[fn].bind(this);
		if (!sortable.options.avoidImplicitDeselect) if (sortable.options.supportPointer) on(document, "pointerup", this._deselectMultiDrag);
		else {
	...
	(function() {
		...
		function classNames() {
			...
			for (var i = 0; i < arguments.length; i++) {
				...
				} else if (argType === "object") if (arg.toString === Object.prototype.toString) {
...
//#endregion
//#region node_modules/react-sortablejs/node_modules/tiny-invariant/dist/tiny-invariant.esm.js
var tiny_invariant_esm_exports = /* @__PURE__ */ __exportAll({ default: () => invariant });
...
var init_tiny_invariant_esm = __esmMin((() => {
	isProduction = false;
	prefix = "Invariant failed";
}));
//#endregion
//#region node_modules/react-sortablejs/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function $eb03e74f8f7db1f3$export$4655efe700f887a(evt, list) {
		...
		return $eb03e74f8f7db1f3$export$bc06a3af7dc65f53(custom, list);
	}
	function $eb03e74f8f7db1f3$export$c25cf8080bd305ec(normalized, list) {
		return $eb03e74f8f7db1f3$export$eca851ee65ae17e4(normalized, $eb03e74f8f7db1f3$export$be2da95e6167b0bd(normalized, list));
	}
	...
	/** Holds a global reference for which react element is being dragged */ var $7fe8e3ea572bda7a$var$store = { dragging: null };
	var $7fe8e3ea572bda7a$export$11bbed9ee0012c13 = class extends $8zHUo$react.Component {
		static defaultProps = { clone: (item) => item };
		constructor(props) {
			super(props);
      ...
      `);
		...
		getChildren() {
			...
			return $8zHUo$react.Children.map(children, (child, index) => {
				...
				const filtered = typeof filter === "string" && { [filter.replace(".", "")]: !!item.filtered };
		...
		onAdd(evt) {
			...
			const customs = $eb03e74f8f7db1f3$export$4655efe700f887a(evt, [...$7fe8e3ea572bda7a$var$store.dragging.props.list]);
			$eb03e74f8f7db1f3$export$77f49a256021c8de(customs);
			setList($eb03e74f8f7db1f3$export$eca851ee65ae17e4(customs, list, evt, clone).map((item) => Object.assign(item, { selected: false })), this.sortable, $7fe8e3ea572bda7a$var$store);
		}
		onRemove(evt) {
			...
			if (evt.pullMode !== "clone") newList = $eb03e74f8f7db1f3$export$be2da95e6167b0bd(customs, newList);
				...
				switch (mode) {
					...
					case "normal":
						...
						break;
					default: $parcel$interopDefault($8zHUo$tinyinvariant)(true, `mode "${mode}" cannot clone. Please remove "props.clone" from <ReactSortable/> when using the "${mode}" plugin`);
				}
		...
		onUpdate(evt) {
			...
			$eb03e74f8f7db1f3$export$77f49a256021c8de(customs);
			$eb03e74f8f7db1f3$export$a6177d5829f70ebc(customs);
			return setList($eb03e74f8f7db1f3$export$c25cf8080bd305ec(customs, list), this.sortable, $7fe8e3ea572bda7a$var$store);
		}
		onStart() {
		...
		onChoose(evt) {
			...
			setList(list.map((item, index) => {
				let newItem = item;
				if (index === evt.oldIndex) newItem = Object.assign(item, { chosen: true });
				return newItem;
			}), this.sortable, $7fe8e3ea572bda7a$var$store);
		}
		onUnchoose(evt) {
			const { list, setList } = this.props;
			setList(list.map((item, index) => {
				let newItem = item;
				if (index === evt.oldIndex) newItem = Object.assign(newItem, { chosen: false });
				return newItem;
			}), this.sortable, $7fe8e3ea572bda7a$var$store);
		}
		onSpill(evt) {
		...
		onSelect(evt) {
			const { list, setList } = this.props;
			const newList = list.map((item) => Object.assign(item, { selected: false }));
